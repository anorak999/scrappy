...
/**
 * Computes a robust SHA-256 checksum of text content
 * Uses crypto.subtle if available, falls back to djb2
 * 
 * @param {string} content
 * @returns {Promise<string>} Hex representation of checksum
 */
export const computeChecksum = async (content) => {
  ...
  // High-performance fallback: DJB2 hash
  let hash = 5381;
